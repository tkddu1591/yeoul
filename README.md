...
0단계(기반)와 E0(쉬운 모드 기초)가 동작합니다: 저장소 열기, 상태 감지, 변경 파일 목록, diff 보기(한 줄/좌우 전환, 줄 번호), stage/unstage, commit, 저장된 역사 보기, 백업(push), 저장 메시지 자동 제안 — 디자인 토큰·픽토그램 시스템·3열 레이아웃 적용.
