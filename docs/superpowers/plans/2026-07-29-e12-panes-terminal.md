...
- [x] **Step 5: 육안 검증(필수).** 라이트·다크 각각 (a) 탭 3개 있는 도크 (b) 빈 새 탭 — 4장을 스크래치패드(**하이픈 경로** `/private/tmp/claude-501/-Users-sangyeop-kim-git-gui/b4ef6d32-042d-440c-8252-b8944659aa01/scratchpad/`)에 저장하고 `ls`로 확인해 붙인다. 컨트롤러가 육안 검수 후 사용자에게 보낸다.
